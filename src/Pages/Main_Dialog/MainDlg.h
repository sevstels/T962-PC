...
class CMainDlg : public CDialog
{
 ...
 ~CMainDlg();
  ...
  CButton m_but_DevList;
  CComboBox m_combo_devices_list;
  CComboBox m_combo_bt_adapters;
  ...
  afx_msg void OnDoubleClickDeviceList();	
  afx_msg void OnSelchangeDeviceList();
  afx_msg void OnWindowPosChanged(WINDOWPOS* lpwndpos);
  afx_msg void OnTcnSelchangeTab(NMHDR *pNMHDR, LRESULT *pResult);
  afx_msg void OnTcnSelchangingTab(NMHDR *pNMHDR, LRESULT *pResult);
  afx_msg void OnButtonFirmWareUpdate();
  ...
  public:
  afx_msg void OnSelchangeBTAdapters();
  afx_msg void OnSelchangeDevice();
  afx_msg void OnButtonDeviceList();
