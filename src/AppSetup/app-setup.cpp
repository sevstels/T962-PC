...
void CApplSetup::SetDefault(void)
{
  ...
  //bt
  pSetup->bt_last_vid = 0;
  pSetup->bt_last_pid = 0;
  pSetup->bt_enable = 0;

  //----
  memset(pSetup->bt_last_connected_device, 0, 
	     sizeof(pSetup->bt_last_connected_device));
  pSetup->last_transport = -1; //not selected
