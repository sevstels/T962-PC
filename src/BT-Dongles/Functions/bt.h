...
struct bt_hci_cmd_le_set_adv_parameters {
	...
	unsigned char  direct_addr_type;
...
#define BT_HCI_CMD_LE_CONN_PARAM_REQ_REPLY	0x2022
...
struct bt_hci_evt_le_adv_report {
	...
	uint8_t  Address[6];
	uint8_t  Length_Data;
	uint8_t  Data[10]; //Size: Length_Data[i] Octets * Num_Reports
};
